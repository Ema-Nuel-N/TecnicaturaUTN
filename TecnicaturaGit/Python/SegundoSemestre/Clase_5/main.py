...
numbers = [1, 2, 3, 4, 5] # Aún con él la lista vacia se va a ejecutar el else
...
print(f"El resultado es: {sumar(22, 66)}")
...
listarNombres("Lucas", "José", "Claudia","Juan","Maria")
listarNombres("Ramon", "Marcos", "Claudio")

def listaTerminos(**terminos): # Lo más utilizado es **kwargs para recibir los argumentos
